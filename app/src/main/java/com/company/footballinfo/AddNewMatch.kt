...
import com.company.footballinfo.databinding.ActivityAddNewMatchBinding
...
class AddNewMatch : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addMatch.setOnClickListener {
            ...
            database.getReference("Match").addListenerForSingleValueEvent(object :ValueEventListener{
