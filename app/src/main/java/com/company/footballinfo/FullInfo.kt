...
import com.company.footballinfo.databinding.ActivityFullInfoBinding
...
class FullInfo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fulllinkFirstTeam.setText(item.firstImage)
        binding.fulllinkSecTeam.setText(item.secondImage)
